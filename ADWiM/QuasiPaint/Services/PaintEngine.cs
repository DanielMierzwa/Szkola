...
namespace OopPaint.Services
{
    public partial class PaintEngine
    {
        ...
        public void UpdateCurrentColors(FigureColorTarget target, Color color)
        {
            switch (target)
            {
                case FigureColorTarget.Background:
                    FigureSettings = FigureSettings with { CurrentBackgroundColor = color };
                    break;
                case FigureColorTarget.Text:
                    FigureSettings = FigureSettings with { CurrentTextColor = color };
                    break;
                case FigureColorTarget.Border:
                    FigureSettings = FigureSettings with { CurrentBorderColor = color };
                    break;
        ...
        {
            _textControls.AreaLabel.Text = $"{figure.GetArea()} u²";

            _textControls.PerimeterLabel.Text = $"{figure.GetPerimeter()} u";
